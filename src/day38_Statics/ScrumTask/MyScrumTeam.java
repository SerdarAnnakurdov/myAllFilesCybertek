...
import day08_ShortHand_Relation.IdentifyNumber;
...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        developer5.setInfo("Adil", "GR-24", "Full-Stack Developer", "Javaholics", 180000, 'M');
        developer6.setInfo("Ahmed", "GR-24", "Full-Stack Developer", "Javaholics", 190000, 'M');
        ...
        // print the names & salary of every songle testers
        ...
        System.out.println("===================================================");
        // print the name & salary of every developers
        ...
        for (int i = 0; i <= scrumList.size()-1; i++) {
            ...
            for (int j = 0; j <= eachTeam.testersTeam.size() - 1; j++) { // j is index of nm of testers
